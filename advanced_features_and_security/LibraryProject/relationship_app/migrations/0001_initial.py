...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('can_add_book', 'Can add a new book'), ('can_view_book', 'Can view book details'), ('can_change_book', 'Can change book details'), ('can_delete_book', 'Can delete a book')],
            },
        ),
        migrations.CreateModel(
            name='Library',
